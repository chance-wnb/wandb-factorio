...
*Note: Recommend to have a auto-cleanup mechanism for Pipe. It should automatically rebuilds the pipe on startup and deletes it on exit, requiring no manual maintenance.*
